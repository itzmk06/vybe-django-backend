...
def register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # Sending HTML email properly
            email = EmailMultiAlternatives(
                subject=mail_subject,
                body='',  # Plain text body (can be empty or you can put a fallback message)
                from_email=None,  # Optional: put your "from" email if you want
                to=[to_email],
            )
